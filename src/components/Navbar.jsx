...
const Navbar = () => {
  return (
    <Box bg="#fff1e5" color="white" px={4}>
      <Flex h={16} alignItems="center" justifyContent="space-between">
        <HStack spacing={8} alignItems="center">
          ...
          <HStack as="nav" spacing={4} display={{ base: "none", md: "flex" }}>
            ...
            <Link as={NavLink} to="/world" _hover={{ textDecoration: "none" }} _activeLink={{ color: "teal.500" }}>World</Link>
            <Link as={NavLink} to="/business" _hover={{ textDecoration: "none" }} _activeLink={{ color: "teal.500" }}>Business</Link>
            ...
            <Link as={NavLink} to="/tech" _hover={{ textDecoration: "none" }} _activeLink={{ color: "teal.500" }}>Tech</Link>
          </HStack>
        </HStack>
        <Spacer />
      </Flex>
